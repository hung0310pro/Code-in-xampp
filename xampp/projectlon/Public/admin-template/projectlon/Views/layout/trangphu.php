					...
					<ul class="header-btns">
						...
						<li class="header-account dropdown default-dropdown">
							...
							<ul class="custom-menu">
								...
								<li><a href="?controller=trangphu-sanpham&action=logout"><i class="fa fa-user-plus"></i>Thoát</a></li>
							<?php }
							else { ?>
		...
		<div class="container">
			<div id="responsive-nav">
				...
				<?php foreach($list_theloai as $key => $theloai){
				 ...
				 ?>
						<li class="dropdown side-dropdown"><a href="?controller=trangphu-sanpham&action=sanphamdanhmuc&id=<?=$theloai['id']?>"><?= $theloai["ten_the_loai"]; ?> </a></li>
					<?php } ?>
					</ul>
				</div>
				<!-- /category nav -->
