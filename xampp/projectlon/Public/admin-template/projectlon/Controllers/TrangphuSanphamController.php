...
/*
 ...
 //$_SESSION["giohang"]["2"] = 3; khi đó
    ...
    if(isset($_SESSION["giohang"])){
        ...
        $this->views->listsp_giohang = $objModel2->listhome(array("in_list_thanhtoan"=>$this->views->chuoi_id_sach));// cái này truyền sang sanphammodel.php;
