    ...
    <div id="bodythanhtoan">
		    	...
		    	<table>
		    		<tr>
		    			...
		    			<td><input type="text" name="username" size="45">
		    			 <?php echo "<br>"; $header_dn->show_error($loi, 'name'); ?>
		    			 </td>
		    		</tr>
		    		<tr>
		    			<td>Điện thoại</td>
		    			<td><input type="text" name="telephone" size="45">
		    			 <?php echo "<br>"; $header_dn->show_error($loi, 'phone'); ?>
		    			 </td>
		    		</tr>
		    		<tr>
		    			<td>Địa chỉ</td>
		    			<td><input type="text" name="address" size="45">
		    			 <?php echo "<br>"; $header_dn->show_error($loi, 'diachi'); ?>
		    			 </td>
		    		</tr>
		    		<tr>
		    			<td>Địa chỉ giao hàng</td>
		    			<td><input type="text" name="addressgh" size="45">
		    			 <?php echo "<br>"; $header_dn->show_error($loi, 'diachigh'); ?>
		    			 </td>
		    		</tr>
		    		<tr>
		    			<td>Email</td>
		    			<td><input type="text" name="email" size="45">
		    			 <?php echo "<br>"; $header_dn->show_error($loi, 'emails'); ?>
		    			</td>
		    		</tr>
		    	</table>
	    	</div>
	    ...
	    <div id="hinhthucthanhtoan">
	    	...
	    	<div id="check">
	    		...
	    		<?php echo "<br>"; $header_dn->show_error($loi, 'tratien'); ?>
	    	</div>
	    </div>
