		...
		<div id="body">
			<div id="left">
				<?php
					...
					$data = $header->get_list($sql);
						echo"<ul>";
							echo"<li style='background-color: #555555;color: white;font-size: 19px;'>Danh Mục</li>";
						foreach ($data as $key => $value) {
							echo"<li><a href='danhmucsp.php?id=$value[tb_theloai_id]'>$value[the_loai_sach]</a></li>";
						}
					    echo"</ul>";
			    ?>
			</div>